  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-r from-primary via-accent to-secondary relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className={`text-4xl md:text-5xl font-bold text-white mb-6 text-balance transition-all duration-700 ${
          isVisible ? 'animate-fade-in-up' : 'opacity-0'
        }`}>
          Ready to Simplify Exam Scheduling?
        </h2>
        <p className={`text-xl text-white/90 mb-8 max-w-2xl mx-auto text-balance transition-all duration-700 ${
          isVisible ? 'animate-fade-in-up' : 'opacity-0'
